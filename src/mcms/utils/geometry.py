...
def perspective_projection(points, rotation, translation,
    ...
    Input:
        ...
        cam_intr (bs, 3, 3): Camera intrinsics
    """
    ...
    projected_points = torch.einsum('bij,bkj->bki', cam_intr, projected_points)
...
def lstsq_triangulation(intrinsic,extrinsic,points_2d):
    '''
    '''
